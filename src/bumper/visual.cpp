...
namespace fog_rviz_plugins
{
  ...
  namespace bumper
  {
    ...
    Visual::Visual(Ogre::SceneManager* scene_manager, Ogre::SceneNode* parent_node)
    {
      ...
      /* m_sector_lines.reset(new rviz_rendering::BillboardLine( scene_manager_, frame_node_ )); */
    }
    ...
    std::shared_ptr<rviz_rendering::Object> Visual::draw_no_data(const unsigned sector_it, const unsigned n_horizontal_sectors)
    {
      ...
      std::shared_ptr<rviz_rendering::BillboardLine> ret = std::make_shared<rviz_rendering::BillboardLine>(scene_manager_, frame_node_);
    ...
    std::shared_ptr<rviz_rendering::Object> Visual::draw_horizontal_sector(const double dist, const double vfov, const double hfov, const double yaw)
    {
    ...
    std::shared_ptr<rviz_rendering::Object> Visual::draw_topdown_sector(const double dist, const double vfov, const unsigned n_horizontal_sectors)
    {
      std::shared_ptr<rviz_rendering::MeshShape> mesh_ptr = std::make_shared<rviz_rendering::MeshShape>(scene_manager_, frame_node_);
    ...
    /* draw_lidar1d() method //{ */
    std::shared_ptr<rviz_rendering::Object> Visual::draw_lidar1d(const double dist, const unsigned sector_it, const unsigned n_horizontal_sectors)
    {
      std::shared_ptr<rviz_rendering::Arrow> arr_ptr = std::make_shared<rviz_rendering::Arrow>(scene_manager_, frame_node_);
    ...
    /* draw_lidar2d() method //{ */
    std::shared_ptr<rviz_rendering::Object> Visual::draw_lidar2d(const double dist, const unsigned sector_it, const unsigned n_horizontal_sectors)
    {
    ...
    /* setMessage() method //{ */
    void Visual::setMessage(msg_t::ConstSharedPtr msg)
    {
      m_msg = msg;
    ...
    /* draw_message() method //{ */
    void Visual::draw_message(const msg_t::ConstSharedPtr& msg, display_mode_t display_mode)
    {
      if (msg == nullptr)
        return;
